  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="订单编号" prop="dingdanbianhao">
              <el-input v-model="ruleForm.dingdanbianhao" 
                placeholder="订单编号" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="零食名称" prop="lingshimingcheng">
          <el-select  @change="lingshimingchengChange" v-model="ruleForm.lingshimingcheng" placeholder="请选择零食名称">
            <el-option
                v-for="(item,index) in lingshimingchengOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.lingshimingcheng" label="零食名称" prop="lingshimingcheng">
              <el-input v-model="ruleForm.lingshimingcheng" 
                placeholder="零食名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="零食分类" prop="lingshifenlei">
          <el-input v-model="ruleForm.lingshifenlei" 
              placeholder="零食分类" clearable  :readonly="ro.lingshifenlei"></el-input>
        </el-form-item>
        <div v-else>
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                            ...
                                                            this.$http({
              url: `option/lingshixinxi/lingshimingcheng`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
                this.lingshimingchengOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
                    ...
                    // 下二随
    lingshimingchengChange () {
      this.$http({
        url: `follow/lingshixinxi/lingshimingcheng?columnValue=`+ this.ruleForm.lingshimingcheng,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
                                                                                if(data.data.lingshifenlei){
                this.ruleForm.lingshifenlei = data.data.lingshifenlei
              }
                                                if(data.data.pinpai){
                this.ruleForm.pinpai = data.data.pinpai
              }
                                                                                                                                                                                        } else {
          this.$message.error(data.msg);
        }
