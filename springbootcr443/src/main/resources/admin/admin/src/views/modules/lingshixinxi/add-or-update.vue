<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="零食名称" prop="lingshimingcheng">
          <el-input v-model="ruleForm.lingshimingcheng" 
              placeholder="零食名称" clearable  :readonly="ro.lingshimingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="零食名称" prop="lingshimingcheng">
              <el-input v-model="ruleForm.lingshimingcheng" 
                placeholder="零食名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="零食分类" prop="lingshifenlei">
          <el-select v-model="ruleForm.lingshifenlei" placeholder="请选择零食分类">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="零食分类" prop="lingshifenlei">
	      <el-input v-model="ruleForm.lingshifenlei"
                placeholder="零食分类" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="24">  
          ...
          <el-form-item class="input" label="价格" prop="price">
              <el-input v-model="ruleForm.price" 
                placeholder="价格" readonly></el-input>
                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                              <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="零食详情" prop="lingshixiangqing">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.lingshixiangqing" label="零食详情" prop="lingshixiangqing">
                    <span v-html="ruleForm.lingshixiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                            ...
                                                            this.$http({
              url: `option/lingshifenlei/lingshifenlei`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
                this.lingshifenleiOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
	...
	this.ruleForm.lingshixiangqing = this.ruleForm.lingshixiangqing.replace(reg,'../../../springbootcr443/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `lingshixinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.lingshixinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
